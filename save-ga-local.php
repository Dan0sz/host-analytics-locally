            ...
            <table class="form-table">
                ...
                <tr valign="top">
                    ...
                    <td><input type="text" name="sgal_cookie_notice_name"
                               value="<?php echo $sgal_cookie_notice_name; ?>"/></td>
                </tr>
                <tr valign="top">
                    ...
                    <td><input type="number" name="sgal_ga_cookie_expiry_days" min="0" max="365"
                               value="<?php echo $sgal_ga_cookie_expiry_days; ?>"/></td>
                </tr>
                <tr valign="top">
                ...
                <tr valign="top">
                    ...
                    <td>
                        <input type="number" name="sgal_adjusted_bounce_rate" min="0" max="60"
                               value="<?php echo $sgal_adjusted_bounce_rate; ?>"/>
                    </td>
                </tr>
                <tr valign="top">
                    ...
                    <td>
                        <input type="number" name="sgal_enqueue_order" min="0"
                               value="<?php echo $sgal_enqueue_order; ?>"/>
                    </td>
                </tr>
                <tr valign="top">
                    ...
                    <td>
                        <input type="checkbox"
                               name="caos_disable_display_features" <?php if ($caos_disable_display_features == "on") echo 'checked = "checked"'; ?> />
                    </td>
                </tr>
                <tr valign="top">
                    ...
                    <td>
                        <input type="checkbox"
                               name="sgal_anonymize_ip" <?php if ($sgal_anonymize_ip == "on") echo 'checked = "checked"'; ?> />
                    </td>
                </tr>
                <tr valign="top">
                    ...
                    <td>
                        <input type="checkbox"
                               name="sgal_track_admin" <?php if ($sgal_track_admin == "on") echo 'checked = "checked"'; ?> />
                    </td>
                </tr>
                <tr valign="top">
