    ...
    <div class="welcome-panel-content">
        ...
        <div class="welcome-panel-column-container">
            ...
            <div class="welcome-panel-column" style="width: 31%; margin-right: 15px;">
                ...
                <p>
                    <?= __('Superman could reach the other side of the world in 3 seconds. Google wants your website to do it in two. Let\'s give Google a run for its money.', 'host-analyticsjs-local'); ?>
                </p>
                <p>
