	...
	<div class="welcome-panel-content">
		...
		<div class="welcome-panel-column-container">
			<div class="welcome-panel-column">
                ...
                <p><a target="_blank" href="https://dev.daanvandenbergh.com/wordpress-plugins/optimize-analytics-wordpress/"><?php _e('Click here', CAOS_ANALYTICS_TRANSLATE_DOMAIN); ?></a> <?php _e('for a more comprehensive guide.', CAOS_ANALYTICS_TRANSLATE_DOMAIN); ?></p>
                <h3><?php _e('Suggested Reading', CAOS_ANALYTICS_TRANSLATE_DOMAIN); ?></h3>
                <ul>
                    <li class="welcome-icon dashicons-before dashicons-analytics"><a href="https://dev.daanvandenbergh.com/wordpress/leverage-browser-caching-host-analytics-local-monster-insights/" target="_blank"><?php _e('Configure CAOS with Monster Insights and WooCommerce', CAOS_ANALYTICS_TRANSLATE_DOMAIN); ?></a></li>
                    <li class="welcome-icon dashicons-before dashicons-welcome-learn-more"><a href="https://dev.daanvandenbergh.com/wordpress/gdpr-compliance-google-analytics/" target="_blank"><?php _e('Complete Guide to GDPR Compliance with CAOS', CAOS_ANALYTICS_TRANSLATE_DOMAIN); ?></a></li>
                    <li class="welcome-icon dashicons-before dashicons-dashboard"><a href="https://dev.daanvandenbergh.com/wordpress/quick-guide-pagespeed-insights-pingdom/" target="_blank"><?php _e('Speed-up your site: get 100/100 on Pagespeed Insights in 30 minutes!', CAOS_ANALYTICS_TRANSLATE_DOMAIN); ?></a></li>
                </ul>
			</div>
			<div class="welcome-panel-column">
				<h3><?php _e('Get a Perfect Score on Pagespeed & Pingdom!', CAOS_ANALYTICS_TRANSLATE_DOMAIN); ?></h3>
                <p><strong><?php _e('Leverage your browser cache</strong> and <strong>lower pageload times</strong> by hosting your Google Fonts locally with', CAOS_ANALYTICS_TRANSLATE_DOMAIN); ?>
                    <a href="https://dev.daanvandenbergh.com/wordpress/host-google-fonts-locally/" target="_blank"><?php _e('CAOS for Webfonts', CAOS_ANALYTICS_TRANSLATE_DOMAIN); ?></a>.</p>
                <p><a target="_blank" href="https://wordpress.org/plugins/host-webfonts-local/"><?php _e('Download now', CAOS_ANALYTICS_TRANSLATE_DOMAIN); ?></a></p>
                ...
                <?php _e('<p>If not, ask a question on the Support Forum or <a href="https://dev.daanvandenbergh.com/contact/" target="_blank">contact me</a>.</p>', CAOS_ANALYTICS_TRANSLATE_DOMAIN); ?>
			</div>
			<div class="welcome-panel-column welcome-panel-last">
				...
				<a target="_blank" class="button button-primary button-hero" href="https://dev.daanvandenbergh.com/donate/"><span class="dashicons-before dashicons-heart"> <?php _e('Donate', CAOS_ANALYTICS_TRANSLATE_DOMAIN); ?></span></a>
