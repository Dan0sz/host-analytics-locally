    ...
    <div class="welcome-panel-content">
        ...
        <div class="welcome-panel-column-container">
            <div class="welcome-panel-column" style="width: 32%;">
                ...
                <p>
                    <a target="_blank" href="<?= CAOS_ANALYTICS_SITE_URL; ?>/wordpress-plugins/optimize-analytics-wordpress/"><?php _e('Click here', 'host-analyticsjs-local'); ?></a> <?php _e('for a more comprehensive guide.', 'host-analyticsjs-local'); ?>
                </p>
            </div>
            <div class="welcome-panel-column" style="width: 32%;">
                ...
                <p>
                    <strong><?= sprintf(__('Leverage your browser cache%s and %slower pageload times%s by hosting your Google Fonts locally with', 'host-analyticsjs-local'), '</strong>', '<strong>', '</strong>'); ?>
                        <a href="<?= CAOS_ANALYTICS_SITE_URL; ?>/wordpress/host-google-fonts-locally/" target="_blank">OMGF</a>.
                </p>
                <p>
                ...
                <ul>
                    ...
                    <li class="welcome-icon dashicons-before dashicons-dashboard">
                        <a href="<?= CAOS_ANALYTICS_SITE_URL; ?>/wordpress/quick-guide-pagespeed-insights-pingdom/" target="_blank"><?php _e('Speed-up your site: get 100/100 on Pagespeed Insights in 30 minutes!', 'host-analyticsjs-local'); ?></a>
                    </li>
                </ul>
            </div>
