        ...
        <div class="postbox">
            <div class="content">
                ...
                <p class="about-description">
					<?php echo sprintf(
						__( 'Need help configuring %s? Please refer to the links below to get you started.', $this->plugin_text_domain ),
						apply_filters( 'caos_settings_page_title', 'CAOS' )
					); ?>
                </p>
                <div class="column-container">
                    <div class="column">
                        ...
                        <ul>
                            <li><a target="_blank" href="<?php echo apply_filters(
									'caos_settings_help_quick_start',
									'https://daan.dev/docs/caos/quick-start-caos/'
								); ?>"><i class="dashicons dashicons-controls-play"></i><?php echo __( 'Quick Start Guide', $this->plugin_text_domain ); ?></a></li>
                            <li><a target="_blank" href="<?php echo apply_filters(
									'caos_settings_help_user_manual',
									'https://daan.dev/docs/caos/?collection_id=6171c32112c07c18afddfcce'
								); ?>"><i class="dashicons dashicons-text-page"></i><?php echo __( 'User Manual', $this->plugin_text_domain ); ?></a></li>
                            <li><a target="_blank" href="<?php echo apply_filters(
									'caos_settings_help_faq_link',
									'https://daan.dev/docs/caos-troubleshooting/?collection_id=6171c32112c07c18afddfcce'
								); ?>"><i class="dashicons dashicons-editor-help"></i><?php echo __( 'FAQ & Troubleshooting', $this->plugin_text_domain ); ?></a></li>
                            <li><a target="_blank" href="<?php echo apply_filters( 'caos_settings_help_support_link', 'https://daan.dev/contact/' ); ?>"><i class="dashicons dashicons-bell"></i><?php echo __(
										'Get Support',
                    ...
                    <div class="column">
                        ...
                        <ul>
                            <li><a target="_blank" href="<?php echo apply_filters(
									'caos_settings_help_review_link',
									'https://wordpress.org/support/plugin/host-analyticsjs-local/reviews/?rate=5#new-post'
								); ?>"><i class="dashicons dashicons-star-filled"></i><?php echo __( 'Write a 5-star Review or,', $this->plugin_text_domain ); ?></a></li>
                    ...
                    <div class="column last">
                        ...
                        <p class="signature">
                            <a target="_blank" title="<?php echo __(
								'Visit Daan.dev',
								$this->plugin_text_domain
