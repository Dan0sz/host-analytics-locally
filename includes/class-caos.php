...
class CAOS
{
    ...
    public function define_constants()
    {
        ...
        define('CAOS_OPT_DUAL_TRACKING', esc_attr(apply_filters('caos_opt_dual_tracking', get_option(CAOS_Admin_Settings::CAOS_BASIC_SETTING_DUAL_TRACKING))));
        ...
        define('CAOS_OPT_ANONYMIZE_IP_MODE', esc_attr(apply_filters('caos_opt_anonymize_ip_mode', get_option(CAOS_Admin_Settings::CAOS_BASIC_SETTING_ANONYMIZE_IP_MODE, ''))));
        define('CAOS_OPT_TRACK_ADMIN', esc_attr(get_option(CAOS_Admin_Settings::CAOS_BASIC_SETTING_TRACK_ADMIN)));
        define('CAOS_OPT_DISABLE_ADS_FEAT', esc_attr(apply_filters('caos_opt_disable_ads_feat', get_option(CAOS_Admin_Settings::CAOS_ADV_SETTING_DISABLE_ADS_FEATURES))));
        ...
        define('CAOS_OPT_EXT_CAPTURE_OUTBOUND_LINKS', esc_attr(apply_filters('caos_opt_capture_outbound_links', get_option(CAOS_Admin_Settings::CAOS_EXT_SETTING_CAPTURE_OUTBOUND_LINKS))));
        define('CAOS_OPT_UNINSTALL_SETTINGS', esc_attr(get_option(CAOS_Admin_Settings::CAOS_ADV_SETTING_UNINSTALL_SETTINGS)));
        define('CAOS_OPT_EXT_TRACK_AD_BLOCKERS', esc_attr(apply_filters('caos_opt_track_ad_blockers', get_option(CAOS_Admin_Settings::CAOS_EXT_SETTING_TRACK_AD_BLOCKERS))));
        define('CAOS_OPT_EXT_LINKID', esc_attr(apply_filters('caos_opt_linkid', get_option(CAOS_Admin_Settings::CAOS_EXT_SETTING_LINKID))));
