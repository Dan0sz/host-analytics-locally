...
<div id="setting-error-settings_updated" class="updated settings-success notice">
    ...
    <p><em>analytics.js</em> <?php _e('last updated at', 'host-analyticsjs-local'); ?>: <?php echo date('Y-m-d H:i:s', caos_analytics_last_updated()); ?></p>
...
<div id="setting-error-settings_updated" class="notice notice-error">
    <p><strong><?php _e('analytics.js hasn\'t been updated for more than two days. Is your cron running?', 'host-analyticsjs-local'); ?></strong></p>
</div>
<?php endif; ?>
...
<div class="caos_left_column" style="float:left; width: 50%;">
    ...
    <table class="form-table">
        <tr valign="top">
            ...
            <td>
                <input type="text" name="sgal_tracking_id" value="<?php echo CAOS_ANALYTICS_TRACKING_ID; ?>"/>
            </td>
        </tr>
        <tbody class="caos_basic_settings" <?php echo CAOS_ANALYTICS_MI_COMPATIBILITY == 'on' ? 'style="display: none;"' : ''; ?>>
        <tr valign="top">
				...
				foreach ( $caos_allow_tracking_choice as $option => $label ): ?>
                    <label>
                        <input type="radio" class="caos_allow_tracking_<?php echo $option; ?>"
							...
							<?php echo $option == CAOS_ANALYTICS_ALLOW_TRACKING ? 'checked="checked"' : ''; ?>/>
        ...
        <tr class="caos_gdpr_setting caos_allow_tracking_name"
            valign="top" <?php echo CAOS_ANALYTICS_ALLOW_TRACKING ? '' : 'style="display: none;"'; ?>>
            <th scope="row"><?php _e( 'Cookie name', 'host-analyticsjs-local'); ?></th>
            <td>
                <input type="text" name="sgal_cookie_notice_name"
                       value="<?php echo CAOS_ANALYTICS_COOKIE_NAME; ?>"/>
                <p class="description">
        ...
        <tr class="caos_gdpr_setting caos_allow_tracking_name caos_allow_tracking_value"
            valign="top" <?php echo CAOS_ANALYTICS_ALLOW_TRACKING == 'cookie_has_value' ? '' : 'style="display: none;"'; ?>>
            <th scope="row"><?php _e( 'Cookie value', 'host-analyticsjs-local' ); ?></th>
            <td>
                <input type="text" name="caos_cookie_value"
                       value="<?php echo CAOS_ANALYTICS_COOKIE_VALUE; ?>"/>
                <p class="description">
				...
				foreach ( $sgal_script_position as $option => $label ): ?>
                    <label>
                        <input class="caos_script_position_<?php echo $option; ?>" type="radio" name="sgal_script_position"
                               value="<?php echo $option; ?>" <?php echo $option == CAOS_ANALYTICS_SCRIPT_POSITION ? 'checked="checked"' : ''; ?> />
                        <?php echo _e($label, 'host-analyticsjs-local'); ?>
                    </label>
                    <br/>
				<?php endforeach; ?>
        ...
        <tr class="caos_add_manually" valign="top" <?php echo CAOS_ANALYTICS_SCRIPT_POSITION == 'manual' ? '' : 'style="display: none;"'; ?>>
    ...
    <table class="form-table">
        <tbody class="caos_mi_compatibility">
            <tr valign="top">
                ...
                <td>
                    <input class="caos_mi_compatibility_checkbox" type="checkbox" name="caos_mi_compatibility" <?php echo CAOS_ANALYTICS_MI_COMPATIBILITY == 'on' ? 'checked = "checked"' : ''; ?> />
                    <p class="description">
        ...
        <tbody class="caos_advanced_settings" <?php echo CAOS_ANALYTICS_MI_COMPATIBILITY == 'on' ? 'style="display: none;"' : ''; ?>>
        <tr valign="top">
            ...
            <td>
                <input type="number" name="sgal_ga_cookie_expiry_days" min="0" max="365"
                       value="<?php echo CAOS_ANALYTICS_COOKIE_EXPIRY; ?>" />
                <p class="description">
        ...
        <tr valign="top">
            ...
            <td>
                <input type="number" name="sgal_adjusted_bounce_rate" min="0" max="60"
                       value="<?php echo CAOS_ANALYTICS_ADJUSTED_BOUNCE_RATE; ?>" />
                <p class="description">
        ...
        <tr valign="top">
            ...
            <td>
                <input type="number" name="sgal_enqueue_order" min="0"
                       value="<?php echo CAOS_ANALYTICS_ENQUEUE_ORDER; ?>" />
                <p class="description">
        ...
        <tr valign="top">
            ...
            <td>
                <input type="checkbox" name="caos_disable_display_features"
                        <?php echo CAOS_ANALYTICS_DISABLE_DISPLAY_FEAT == "on" ? 'checked = "checked"' : ''; ?> />
                <p class="description">
        ...
        <tr valign="top">
            ...
            <td>
                <input type="checkbox" name="sgal_anonymize_ip"
                    <?php echo CAOS_ANALYTICS_ANONYMIZE_IP == "on" ? 'checked = "checked"' : ''; ?> />
                <p class="description">
        ...
        <tr valign="top">
            ...
            <td>
                <input type="checkbox" name="sgal_track_admin"
                    <?php echo CAOS_ANALYTICS_TRACK_ADMIN == "on" ? 'checked = "checked"' : ''; ?> />
                <p class="description">
        ...
        <tr valign="top">
            ...
            <td>
                <input type="checkbox" name="caos_remove_wp_cron"
                    <?php echo CAOS_ANALYTICS_REMOVE_CRON == "on" ? 'checked = "checked"' : ''; ?> />
                <p class="description">
